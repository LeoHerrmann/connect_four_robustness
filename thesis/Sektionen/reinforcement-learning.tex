...
Dementsprechend werden die Parameter der Wertefunktion unter Verwendung des Gradientenverfahrens gemäß Formel (\ref{gradient-descent-formula}) aktualisiert. Der Verlust $L$ wird hierbei mit
